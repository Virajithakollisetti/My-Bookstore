...
function Navbar() {
  ...
  return (
    <>
    <div className={` max-w-screen-2xl container mx-auto md:px-20 px-4 bg-base-100 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${
      count?"count-navbar shawdow-md bg-base-200 dark:bg-slate-600 dark:text-white duration-300 transition-all ease-in-out"
      : ""
    }`}>
  ...
  <label className="px-3 py-2 border rounded-md flex items-center gap-">
...
{ authUser?(
  ...
  <div className="">
    <a className="bg-black text-white p-2 rounded-md cursor-pointer"
